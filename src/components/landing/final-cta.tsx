  ...
  return (
    <section className="w-full py-24 md:py-32 px-5">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="font-satoshi font-black text-[40px] sm:text-[56px] md:text-[72px] leading-[1.05] tracking-[-0.8px] text-ink">
          Seu processo de gente pode andar sozinho <span className="holo-gradient-text">até a hora da sua decisão.</span>
        </h2>
        <p className="mt-5 text-body md:text-[18px] text-ink-muted font-medium">
